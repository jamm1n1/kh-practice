...
public class Run {
	...
	public static void main(String[] args) {
		...
		//1. 클래스를 만들고나서 자바의 객체형태로 만들기위해서 new 연산자를 통해서 heap 메모리 영역에 생성해야한다.(즉, 할당공간)
		Student u = new Student();//객체생성
...
Student s = new Student(); //객체 생성
		...
		//직접 접근을 통한 값 가져오기
		System.out.println(s.name+"님의 나이는"+ s.age + "이고,국어점수는 "+ s.kor +"이고 수학점수는"+s.math+"이다");
