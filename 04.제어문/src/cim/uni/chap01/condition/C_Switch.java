...
public class C_Switch {
	 ...
	 * * switch문
	 * 
	 * switch(동등비교할대상자){ // 여기서 동등비교할 대상자는 반드시 int값이나, char, String 밖에 불가!! case 값1
	...
	public void method1() {
		...
		int num = sc.nextInt();
		/*
		 * System.out.println("정수 : ");  if(num == 1) {
		 * System.out.println("빨간색 입니다."); } else if(num == 2) {
		 * System.out.println("파란색 입니다."); } else if(num == 3) {
		 * System.out.println("초록색 입니다."); }else { System.out.println("잘 못 입력하셨습니다."); }
		 */
