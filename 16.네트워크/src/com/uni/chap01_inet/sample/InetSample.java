...
public class InetSample {
	...
	public void isSample() {
		...
		try {
			InetAddress loaclIp = InetAddress.getLocalHost(); // 내 컴퓨터 ip주소 반환
			System.out.println("내 피씨명" + loaclIp.getHostName());// 호스트 이름반환
			System.out.println("내 피씨명" + loaclIp.getHostAddress());// 호스트의 ip 주소반환

			InetAddress naverIp = InetAddress.getByName("www.naver.com");
			System.out.println("네이버 서버명 피씨명" + naverIp.getHostName());// 호스트 이름반환
			System.out.println("네이버 서버 주소" + naverIp.getHostAddress());// 호스트의 ip 주소반환
